...
public class NeuerKassensturz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_neuer_kassensturz);
...
/*        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_neuer_kasssenstuz, menu);
        return true;
    }
